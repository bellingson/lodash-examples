...
// group the people by gender
// group the people by retired vs working status

var gMap = _.groupBy(people, 'gender');
console.log(gMap);

var statusMap = _.groupBy(people,function(p) { return p.age >= 65 ? 'retired' : 'working'; });
